 ...
 *
 * <p>The Font and foreground Color of the prompt will default to those properties of the parent
 * text component. You are free to change the properties after class construction.
 */
public class TextPrompt extends JLabel implements FocusListener, DocumentListener {
   ...
   *
   * <p>Show.AWLAYS (default) - always show the prompt Show.Focus_GAINED - show the prompt when the
